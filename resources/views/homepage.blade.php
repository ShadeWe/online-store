...
<main role="main">
  <section class="jumbotron text-center" style="margin-bottom: 0;">
    <div class="container">
      ...
      <p class="lead text-muted">Buy something, please</p>
      <p>
        <a href="/categories" class="btn btn-primary my-2">Move to categories</a>
	...
	<div class="text-center" style="margin-top: 10px;">
		  <p class="lead text-muted">The latest products added</p>
	</div>
